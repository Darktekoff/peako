              ...
              <div className="rounded-lg border border-gray-800 bg-gray-900 p-6 sticky top-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {genres.map((genre) => (
                      <span key={genre} className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-orange-500/10 text-orange-400 border border-orange-600/30">
                        {genre}
                      </span>
                    ))}
                  </div>
